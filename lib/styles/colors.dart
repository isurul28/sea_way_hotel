...
final Color lprimaryColor = const Color(0xff3B5998);
final Color lsecondaryColor = const Color(0xff8F9BB3);
...
final Color dprimaryColor = const Color(0xff3B5998);
final Color dsecondaryColor = const Color(0xff8F9BB3);
